...
# JNA - ignore missing AWT classes (not available in Android)
-dontwarn java.awt.**
...
# WS Proxy
-keep class org.telegram.messenger.wsproxy.WsProxyNative { *; }
-keep class org.telegram.messenger.wsproxy.WsProxyNative$Core { *; }
