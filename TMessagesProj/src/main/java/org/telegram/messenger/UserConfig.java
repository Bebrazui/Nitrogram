...
public class UserConfig extends BaseController {
    ...
    public final static int MAX_ACCOUNT_DEFAULT_COUNT = NitrogramConfig.MAX_ACCOUNT_SLOTS;
    public final static int MAX_ACCOUNT_COUNT = NitrogramConfig.MAX_ACCOUNT_SLOTS;
