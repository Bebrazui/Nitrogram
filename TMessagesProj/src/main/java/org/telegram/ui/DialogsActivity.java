                ...
                if (id == -1) {
                    ...
                    sheet.setDelegate((filter, checked) -> {
                        ...
                        if (!checked) {
                            ...
                            if (totalCount > org.telegram.messenger.NitrogramConfig.getFolderChatsLimit(getMessagesController(), getUserConfig().isPremium())) {
                ...
                public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
                    ...
                    if (viewPage.dialogsType == DIALOGS_TYPE_DEFAULT && viewPage.archivePullViewState != ARCHIVE_ITEM_STATE_PINNED && hasHiddenArchive() && !fixScrollYAfterArchiveOpened) {
                        ...
                        if (currentPosition == 0 && firstView != null && (firstView.getBottom() - pTop) >= dp(4)) {
                            ...
                            long pullingTime = System.currentTimeMillis() - startArchivePullingTime;
                            boolean canShowInternal = NitrogramConfig.isOpenArchiveOnPullEnabled() && k > PullForegroundDrawable.SNAP_HEIGHT && pullingTime > PullForegroundDrawable.minPullingTime + 20;
...
//            }
    ...
    public ArrayList<TLRPC.Dialog> getDialogsArray(int currentAccount, int dialogsType, int folderId, boolean frozen) {
        ...
        if (dialogsType == DIALOGS_TYPE_DEFAULT) {
            return org.telegram.messenger.NitrogramConfig.sortDialogsForNitrogram(messagesController.getDialogs(folderId), messagesController);
            ...
            if (dialogFilter == null) {
                ...
                return org.telegram.messenger.NitrogramConfig.sortDialogsForNitrogram(dialogFilter.dialogs, messagesController);
            }
...
//            }
    ...
    public void updateStoriesVisibility(boolean animated) {
        if (org.telegram.messenger.NitrogramConfig.isHideStoriesEnabled()) {
            hasOnlySlefStories = false;
